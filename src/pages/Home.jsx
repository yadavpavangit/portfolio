...
function Home() {
  return (
    <>
      <section className="relative w-full min-h-screen flex items-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-20 overflow-hidden">
        {/* Background Glow */}
